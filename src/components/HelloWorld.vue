      ...
      >
        <div class="sm:flex sm:items-center px-6 py-4">
          <img
            ...
            src="https://i.ytimg.com/vi/e1PfgE0mWds/hqdefault.jpg"
            alt
          />
          <div class="text-center sm:text-left sm:flex-grow">
            <div class="mb-4">
              <p class="text-xl leading-tight">Fernanado Fernandez Valero</p>
              <p
                class="text-sm leading-tight text-grey-dark"
              >Software Developer at cirioSolutions Inc.</p>
            </div>

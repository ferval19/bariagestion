<template>
  <section id="empresa" class="pb-20 relative block bg-red-900">
    ...
    <div class="container mx-auto pt-24 pb-24 pl-4 pr-4 lg:pt-24 lg:pb-64 sm:pb-24 sm:pt-24">
      ...
      <div class="flex flex-wrap mt-12 justify-center">
        <div class="w-full lg:w-4/12 px-4 text-center">
          ...
          <h6 class="text-xl mt-1 font-semibold text-white">Atención personalizada</h6>
          <p
            class="mt-2 mb-12 text-white"
        ...
        <div class="w-full lg:w-4/12 px-4 text-center">
          ...
          <h5 class="text-xl mt-1 font-semibold text-white">Profesionalidad</h5>
          <p
            class="mt-2 mb-12 text-white"
        ...
        <div class="w-full lg:w-4/12 px-4 text-center">
          ...
          <h5 class="text-xl mt-1 font-semibold text-white">Ahorra tiempo</h5>
          <p
            class="mt-2 mb-12 text-white"
